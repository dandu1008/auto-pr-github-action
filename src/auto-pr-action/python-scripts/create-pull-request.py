...
def update_pull_request(github_token, github_repository,
                        pr_number, payload, user):
...
def process_event(github_token, github_repository, branch, base, user):
    title = os.getenv(
        'PULL_REQUEST_TITLE',
...
def main():
    ...
    user = "{pusher[name]}".format(**event_data)
